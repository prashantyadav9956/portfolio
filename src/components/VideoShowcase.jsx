  ...
  topVideos: [
    {
      ...
      videoUrl: "/videos/TOP VIDEOS/1 (2).mp4",
      duration: "0:45",
    ...
    },
    {
      ...
      videoUrl: "/videos/TOP VIDEOS/Draft-Preview (2).mp4",
      duration: "0:30",
  ...
  longVideos: [
    {
      ...
      videoUrl: "/videos/LONG VIDEOS/Origin_Of_Clea__Doctor_Strange_Wife_in_hindi_explained(1080p).mp4",
    ...
    },
    {
      ...
      videoUrl: "/videos/LONG VIDEOS/vidssave.com All Black Panther Suite Explain In Hindi __ Rex Reborn 1080P.mp4",
      duration: "Full Breakdown",
      metrics: "850K+ Views",
  ...
  shortVideos: [
    {
      ...
      videoUrl: "/videos/SHORTS/Secret_Features_Of_Black_Panther_Suite_You_Don_t_Know_#shorts(1080p).mp4",
      duration: "0:58",
