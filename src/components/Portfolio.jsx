...
export default function Portfolio() {
  ...
  const [portfolioTab, setPortfolioTab] = useState('ALL'); // 'ALL', 'DESIGN', 'VIDEO'
    ...
    <section id="portfolio" className="relative py-24 bg-slate-950/40 border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          {/* Main Showcase Mode Tabs */}
          <div className="inline-flex items-center p-1.5 rounded-full glass-panel border-white/10 gap-2 mb-4">
            <button
            ...
            >
              ...
              <span>Full Portfolio & Videos</span>
            </button>

            <button
              onClick={() => setPortfolioTab('DESIGN')}
              className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-bold font-syne tracking-wider transition-all duration-300 ${
                portfolioTab === 'DESIGN'
                  ? 'bg-gradient-to-r from-violet-600 to-cyan-600 text-white shadow-lg shadow-violet-600/30'
                  : 'text-gray-400 hover:text-white'
            ...
            >
              ...
              <span>Design Case Studies</span>
            </button>

            <button
              onClick={() => setPortfolioTab('VIDEO')}
              className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-bold font-syne tracking-wider transition-all duration-300 ${
                portfolioTab === 'VIDEO'
                  ? 'bg-gradient-to-r from-violet-600 to-cyan-600 text-white shadow-lg shadow-violet-600/30'
                  : 'text-gray-400 hover:text-white'
        ...
        {/* Section 1: Design Case Studies Grid */}
        ...
        {/* Section 2: Dedicated Video Showcase Vault */}
      ...
      {/* Detail Popup Modal with Prev & Next Arrows */}
      <ProjectModal
