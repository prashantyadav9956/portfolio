...
const certificates = [
  {
    ...
    date: 'Jan 2023',
    type: 'image',
    src: '/Certificate/20230126_233439.png',
    color: 'from-violet-600 via-purple-700 to-indigo-800',
    badge: '⭐ Gold',
    skills: ['SEO', 'SEM', 'Analytics', 'Campaign Strategy'],
  },
  {
    id: 'cert-2',
    ...
    date: 'Jan 2023',
    type: 'image',
    src: '/Certificate/20230127_124357.png',
    color: 'from-cyan-600 via-blue-700 to-indigo-800',
    badge: '🎨 Design',
    skills: ['Adobe Illustrator', 'Brand Identity', 'Typography'],
  },
  {
    id: 'cert-3',
    title: 'Advanced Video Production',
    issuer: 'Udemy / YouTube',
    date: 'Jan 2023',
    type: 'image',
    src: '/Certificate/20230130_154841.png',
    color: 'from-rose-600 via-pink-700 to-purple-800',
    badge: '🎬 Cinema',
    skills: ['Premiere Pro', 'Color Grading', 'Motion Design'],
  },
  {
    id: 'cert-4',
    title: 'AI Content Creation',
    issuer: 'Midjourney / Runway',
    date: 'Jan 2023',
    type: 'image',
    src: '/Certificate/20230130_155145.png',
    color: 'from-emerald-600 via-teal-700 to-cyan-800',
    badge: '🤖 AI',
    skills: ['Midjourney', 'Stable Diffusion', 'AI Motion'],
  },
  {
    id: 'cert-5',
    ...
    date: 'Jan 2023',
    type: 'image',
    src: '/Certificate/20230131_103327.png',
    color: 'from-orange-600 via-amber-700 to-yellow-800',
    badge: '📱 Social',
    skills: ['Instagram Growth', 'Content Strategy', 'Reels'],
  },
  {
    id: 'cert-6',
    title: 'Graphic Design Professional',
    issuer: 'Canva Pro / HubSpot',
    date: 'Jan 2023',
    type: 'image',
    src: '/Certificate/20230131_205139.png',
    color: 'from-fuchsia-600 via-violet-700 to-purple-800',
    badge: '🖌️ Design',
    skills: ['Canva Pro', 'Visual Hierarchy', 'Poster Design'],
  },
  {
    id: 'cert-7',
    ...
    date: 'Feb 2023',
    type: 'image',
    src: '/Certificate/20230212_224703.png',
    color: 'from-blue-600 via-sky-700 to-cyan-800',
    badge: '✍️ Story',
    skills: ['Copywriting', 'Storytelling', 'Brand Voice'],
  },
  {
    id: 'cert-8',
    title: 'Digital Marketing Certificate',
    issuer: 'Official Institute',
    date: '2023',
    type: 'pdf',
    src: '/Certificate/eCertificate.pdf',
    color: 'from-violet-700 via-purple-800 to-indigo-900',
    badge: '📜 Official',
    skills: ['Marketing Strategy', 'Digital Campaigns', 'ROI'],
  },
  {
    id: 'cert-9',
    ...
    badge: '🏆 Award',
    skills: ['Leadership', 'Project Management', 'Excellence'],
  },
];
    ...
    <section className="py-8">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-6 mt-6">
          {[
            { Icon: BadgeCheck, label: '9 Certificates', color: 'text-cyan-400' },
            { Icon: Star,       label: '5+ Disciplines', color: 'text-amber-400' },
            { Icon: Award,      label: 'Globally Recognized', color: 'text-violet-400' },
